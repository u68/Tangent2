...
#ifdef __LCCU16__
typedef __attribute__((__aligned__(2))) struct {
	unsigned short _Mode;
	short _Handle;
	unsigned char __near *_Buf;
	unsigned char __near *_Bend;
	unsigned char __near *_Next;
	unsigned char __near *_Rend;
	unsigned char __near *_Rsave;
	unsigned char __near *_Wend;
